...
class Evaluator:
    ...
    def update(self, document, is_event):
        pred_clusters = document.predicted_event_clusters if is_event else \
            document.predicted_entity_clusters
        gold_clusters = document.gold_event_clusters if is_event else\
            document.gold_entity_clusters
        mention_to_gold = document.event_mention_to_gold_cluster if is_event else\
            document.entity_mention_to_gold_cluster
        mention_to_predicted = document.event_mention_to_predicted_cluster if is_event else\
            document.entity_mention_to_predicted_cluster
