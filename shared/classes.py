...
class Topic(object):
    ...
    def add_gold_mention(self, mention, eventOrEntity):
        '''
        ...
        :param eventOrEntity: a string having values: "event" or "entity" that indicates whether the mention is an event mention or an
         entity mention
        '''
        if eventOrEntity == "event":
            self.event_mentions.append(mention)
        else:
    ...
    def match_predicted_to_gold_mention(self, pred_mention, is_event, relaxed_match):
        ...
        for gold_mention in gold_mentions:
            if pred_mention.mention_str == gold_mention.mention_str and \
                ...
                found = True
                break
            elif relaxed_match and self.same_head(pred_mention,
                                                  gold_mention) and not gold_mention.has_compatible_mention:  # not sure about the has_compatible_mention
                pred_mention.has_compatible_mention = True
                gold_mention.has_compatible_mention = True
                pred_mention.gold_mention_id = gold_mention.mention_id
                pred_mention.gold_tokens = gold_mention.tokens
                ...
                found = True
                break
            elif relaxed_match and self.i_within_i(pred_mention,
...
class EventMention(Mention):
    ...
    def __str__(self):
        ...
        return '{}_a0: {}_a1: {}_loc: {}_tmp: {}_{}'.format(super(EventMention, self).__str__(), a0, a1, aloc, atmp,
                                                            self.mention_id)
...
class Token(object):
    ...
    def __init__(self, token_id, token, gold_coref_chain=None):
        '''
